...
function image2txt
	tesseract -l eng $argsv output_from_ocr
...
alias rcupdate='wget -O ~/.config/fish/config.fish https://github.com/MANICX100/setup_scripts/raw/main/fish_aliases.fish'
